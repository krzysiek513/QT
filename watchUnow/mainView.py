...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeWidget.setGeometry(QtCore.QRect(0, 0, 190, 440))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.headerItem().setText(0, _translate("MainWindow", "life"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        self.treeWidget.topLevelItem(0).setText(0, _translate("MainWindow", "korzeń"))
        self.treeWidget.topLevelItem(0).child(0).setText(0, _translate("MainWindow", "Nowy podelement"))
        self.treeWidget.topLevelItem(0).child(0).child(0).setText(0, _translate("MainWindow", "Nowy podelement"))
        self.treeWidget.topLevelItem(0).child(0).child(0).child(0).setText(0, _translate("MainWindow", "Nowy podelement"))
        self.treeWidget.topLevelItem(0).child(0).child(0).child(0).child(0).setText(0, _translate("MainWindow", "Nowy podelement"))
        self.treeWidget.topLevelItem(0).child(0).child(0).child(1).setText(0, _translate("MainWindow", "Nowy element"))
        self.treeWidget.topLevelItem(0).child(0).child(0).child(2).setText(0, _translate("MainWindow", "Nowy element"))
        self.treeWidget.topLevelItem(0).child(0).child(0).child(3).setText(0, _translate("MainWindow", "Nowy podelement"))
        self.treeWidget.topLevelItem(1).setText(0, _translate("MainWindow", "sd"))
        self.treeWidget.topLevelItem(2).setText(0, _translate("MainWindow", "d"))
        self.treeWidget.topLevelItem(2).child(0).setText(0, _translate("MainWindow", "Nowy podelement"))
        self.treeWidget.topLevelItem(2).child(0).child(0).setText(0, _translate("MainWindow", "Nowy podelement"))
